...
function Interceptor(nextHandler) {
   ...
   */
  const onCall = R.curry(function (index, value) {
   ...
   * @param value - A return value or a function with modified behavior.
   */
  this.withArgs = R.curry(function (args, value) {
    const handler = makeHandler(value);
    ...
    const resolveHandler = R.compose(whichHandler, matchCurrentArgs, extractInput);
